...
public record AggregationResponse(List<SingleValue> tags, List<SingleValue> categories, List<RangeValue> prices,
                                  List<RangeValue> ratings, List<Product> results) {
